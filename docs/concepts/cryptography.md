...
**Share Distribution**: To share $s$ a **dealer** first creates a polynomial
...
**Share Distribution**: Every participant $i$ creates a (random) secret
...
To learn more about the background of Drand, we refer to the
